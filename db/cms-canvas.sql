...
-- ----------------------------
-- Table structure for `categories_entries`
-- ----------------------------
...
-- ----------------------------
-- Records of content_fields
-- ----------------------------
INSERT INTO content_fields VALUES ('1', '1', '1', 'Left Column', 'left_column', '0', null, null, '1');
INSERT INTO content_fields VALUES ('2', '1', '1', 'Right Column', 'right_column', '0', null, null, '2');

-- ----------------------------
-- Table structure for `content_field_types`
-- ----------------------------
...
-- ----------------------------
-- Records of content_field_types
-- ----------------------------
INSERT INTO content_field_types VALUES ('1', 'CKEditor', 'ckeditor', 'text');
INSERT INTO content_field_types VALUES ('2', 'TinyMCE', 'tinymce', 'text');
INSERT INTO content_field_types VALUES ('3', 'Text', 'text', 'text');
INSERT INTO content_field_types VALUES ('4', 'Dropdown', 'dropdown', 'text');
INSERT INTO content_field_types VALUES ('5', 'Radio', 'radio', 'text');
INSERT INTO content_field_types VALUES ('6', 'Textarea', 'textarea', 'text');
INSERT INTO content_field_types VALUES ('7', 'HTML', 'html', 'text');
INSERT INTO content_field_types VALUES ('8', 'Image', 'image', 'text');
INSERT INTO content_field_types VALUES ('9', 'File', 'file', 'text');
INSERT INTO content_field_types VALUES ('10', 'Date', 'date', 'date');
INSERT INTO content_field_types VALUES ('11', 'Date Time', 'datetime', 'datetime');
INSERT INTO content_field_types VALUES ('12', 'Page URL', 'page_url', 'text');
INSERT INTO content_field_types VALUES ('13', 'Gallery', 'gallery_id', 'int');
INSERT INTO content_field_types VALUES ('14', 'Checkbox', 'checkbox', 'text');
INSERT INTO content_field_types VALUES ('15', 'Integer', 'text', 'int');
...
-- ----------------------------
INSERT INTO content_types VALUES ('1', 'Page', 'page', '<div id=\"left_column\">\n    <article>\n	<h1>{{ title }}</h1>\n	{{ left_column }}\n    </article>\n</div>\n\n<div id=\"right_column\">\n    <aside>\n	{{ right_column }}\n    </aside>\n</div>', null, 'default', null, '0', '0', null, '0', '1', '5', null, null);
INSERT INTO content_types VALUES ('2', 'Contact Page', 'contact_page', '<h1>{{ title }}</h1>\r\n{{ contact:form }}', null, 'default', null, '0', '0', null, '0', '1', '5', null, null);

-- ----------------------------
-- Table structure for `content_types_admin_groups`
-- ----------------------------
...
-- ----------------------------
-- Records of content_types_admin_groups
-- ----------------------------
...
-- Records of entries
-- ----------------------------
INSERT INTO entries VALUES ('1', 'home', 'Home', null, '0', '1', 'published', null, null, null, '2012-03-06 21:07:07', '2012-03-11 16:13:42', null);
INSERT INTO entries VALUES ('2', null, 'Page Not Found', null, '0', '1', 'published', null, null, null, '2012-03-06 22:55:06', '2012-03-06 22:55:20', null);
INSERT INTO entries VALUES ('3', 'contact', 'Contact', null, '0', '2', 'published', null, null, null, '2012-03-07 21:45:48', '2012-03-07 21:46:56', null);
INSERT INTO entries VALUES ('4', 'about', 'About', null, '0', '1', 'published', null, null, null, '2012-03-11 16:06:40', '2012-03-11 16:12:13', null);

-- ----------------------------
-- Table structure for `entries_data`
-- ----------------------------
...
-- ----------------------------
INSERT INTO navigations VALUES ('1', 'Main Navigation', '0');
...
-- ----------------------------
INSERT INTO navigation_items VALUES ('1', 'page', '1', null, null, null, null, null, '0', '1', 'show', '0', '0', '0', '0');
INSERT INTO navigation_items VALUES ('2', 'page', '4', null, null, null, null, null, '1', '1', 'show', '0', '0', '0', '1');
INSERT INTO navigation_items VALUES ('3', 'page', '3', null, null, null, null, null, '0', '1', 'show', '0', '0', '0', '2');
...
-- ----------------------------
-- Records of revision_resource_types
-- ----------------------------
INSERT INTO revision_resource_types VALUES ('1', 'Entry', 'ENTRY');
INSERT INTO revision_resource_types VALUES ('2', 'Content Type', 'CONTENT_TYPE');
INSERT INTO revision_resource_types VALUES ('3', 'Snippet', 'SNIPPET');
...
-- Records of settings
-- ----------------------------
INSERT INTO settings VALUES ('1', 'site_name', 'CMS Canvas', null);
INSERT INTO settings VALUES ('2', 'ga_account_id', '', null);
INSERT INTO settings VALUES ('3', 'suspend', '0', null);
INSERT INTO settings VALUES ('4', 'enable_admin_toolbar', '1', null);
INSERT INTO settings VALUES ('10', 'custom_404', '2', 'content');
INSERT INTO settings VALUES ('6', 'site_homepage', '1', 'content');
INSERT INTO settings VALUES ('7', 'enable_registration', '0', 'users');
INSERT INTO settings VALUES ('8', 'default_group', '2', 'users');
INSERT INTO settings VALUES ('9', 'email_activation', '0', 'users');
INSERT INTO settings VALUES ('11', 'ga_email', '', null);
INSERT INTO settings VALUES ('12', 'ga_password', '', null);
INSERT INTO settings VALUES ('13', 'ga_profile_id', '', null);
INSERT INTO settings VALUES ('14', 'theme', 'default', null);
INSERT INTO settings VALUES ('15', 'layout', 'default', null);
INSERT INTO settings VALUES ('16', 'enable_profiler', '0', null);
INSERT INTO settings VALUES ('17', 'notification_email', 'ngocdungdinh@gmail.com', null);
INSERT INTO settings VALUES ('18', 'editor_stylesheet', 'assets/css/content.css', null);
INSERT INTO settings VALUES ('19', 'enable_inline_editing', '0', null);
...
-- Records of users
-- ----------------------------
INSERT INTO users VALUES ('1', '37e91ebd9bddede9d329f36b1116cd08', 'Ngoc Dung', 'Dinh', 'ngocdungdinh@gmail.com', null, null, null, null, null, null, '1', '1', '1', null, null, '2014-05-31 10:22:16');
